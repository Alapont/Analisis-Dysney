...
womens = ["RAFIKI, KIARA, AND CHORUS", 'RAFIKI AND KIARA', "KIARA AND KOVU", 'NALA', 'KIARA, TIMON, AND PUMBAA', 'SARAFINA',
'KOVU AND KIARA', 'KIARA', 'LAST CHANCE, ZIRA', 'ZIRA', 'WITCHES', 'CHILD CORPSE TRIO',
'JACK & SALLY']
origin = 'CountWords'
destination = 'GendersCount'

filename = 'TheLionKingIISimbasPride.csv'
