...
womens = ["YOUNG JUDY",'ASTRONAUT SHEEP', 'BONNIE HOPPS', 'FRU FRU SHREW', 'FEMALE BOBCAT NEWS ANCHOR',
'SHARLA','BELLWETHER','HIPPO CHILD','PIG','PRISCILLA'
,'ANGRY GERBIL LADY','HOPPS','PRED ANCHOR','HOPPS','COTTON', 'GAZELLE', 'RABBIT MOM'
, 'MRS. OTTERTON', 'JUDY', 'DHARMA ARMADILLO']

origin = 'CountWords'
destination = 'GendersCount'

filename = 'Zootropia.csv'
