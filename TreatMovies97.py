...
womens = ["WANDA MAXIMOFF", 'DR. HELEN CHO', "FRIDAY", "PEGGY CARTER", 'LILA BARTON',
 "BARTON'S DAUGHTER", 'LAURA BARTON', 'MADAME B', 'MARIA HILL', 'NATASHA ROMANOFF', "ZRINKA"]
origin = 'CountWords'
destination = 'GendersCount'

filename = 'TheAvengersAgeOfUltron.csv'
