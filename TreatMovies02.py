...
frases = [re.compile(r'^[ ]{20}[\w\.\`\"\-\']', re.IGNORECASE),
          re.compile(r'^[ ]{18}[\w\.\`\"\-\']', re.IGNORECASE),
          re.compile(r'^[ ]{2}[\w\.\`\"\-\']', re.IGNORECASE),
          re.compile(r'^[ ]{18}[\w\.\`\"\-\']', re.IGNORECASE),
          ...
          re.compile(r'^[ ]{10,18}[\w\.\`\"\-\'\(\*\?]', re.IGNORECASE),
          re.compile(r'^[ ]{12}[\w\.\`\"\-\'\(\*\?]', re.IGNORECASE),
          re.compile(r'^[ ]{20}[\w\.\`\"\-\'\(\*\?]', re.IGNORECASE),
          re.compile(r'^[ ]{15,20}[\w\.\`\"\-\'\(\*\?]', re.IGNORECASE),
          re.compile(r'^[ ]{20,25}[\w\.\`\"\-\'\(\*\?]', re.IGNORECASE),
          re.compile(r'^[ ]{20,27}[\w\.\`\"\-\'\(\*\?\[]', re.IGNORECASE),
...
cabecera = [33, 31, 25, 13, 34, 8, 20, 80, 26, 36, 34, 55, 16, 80, 17, 128, 32, 42, 60, 14]
