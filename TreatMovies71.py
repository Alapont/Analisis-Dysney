...
womens = ["ANNA AND ELSA", 'YOUNG ELSA', 'YOUNG ANNA', 'GERDA',
          'GIRL TROLLS', 'ELSA', 'ANNA','TEEN ANNA', 'MOTHER','TOWNSWOMAN WITH BABY',"KIDNEY STONE TROLL"
          ,'YOUNG ANNA','ANNA/HANS','YOUNG ELSA & KING','QUEEN','TEEN ELSA']
