...
womens = ["OLD TIAS", 'MAMÁ IMELDA', 'MAMÁ COCO', 'WOMAN',
          'ABUELITA', 'TÍA ROSITA', 'PRIMA ROSA', 'DE LA CRUZ/MAMÁ IMELDA','FRIDA','TÍA VICTORIA','TÍA GLORIA','CECILIA','MIFFED WIFE','NUN','SKELETON ABUELA','LOLA'
          'MAMÁ','TÍA CHELO']
