...
womens = ["WOMAN", 'GIRL', "REY",'JESS','MAZ','CAPTAIN PHASMA'
,'YOUNG GIRL','BAZINE','YOUNG GIRL','LEIA'
,'LYRA','ELIZABETH SWANN','GISELLE']

origin = 'CountWords'
destination = 'GendersCount'

filename = "StarWarsEpisodeVIITheForceAwakens.csv"
