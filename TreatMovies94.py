...
womens = ["ELASTIGIRL", 'VIOLET', "MR. INCREDIBLE/ELASTIGIRL", 'KARI', 'GIRL',
 'HONEY', 'WOMAN', 'DASH/VIOLET', 'VIOLET/DASH', 'MRS. HOGENSON', "HUPH'S SECRETARY",
 'OLD LADY', 'HELEN', 'BOB/HELEN']
origin = 'CountWords'
destination = 'GendersCount'

filename = 'TheIncredibles.csv'
