...
womens = ["WOMAN", 'GIRL', "SWANN",'ELIZABETII','JACK/ELIZABETH','ELIZABETH','SWAN','ANAMARIA','ESTRELLA','YOUNG ELIZABETH'
,'TIA DALMA','ELIZABETH SWANN','GISELLE']

origin = 'CountWords'
destination = 'GendersCount'

filename = "PiratesOfTheCaribbeanDeadMan'sChest.csv"
